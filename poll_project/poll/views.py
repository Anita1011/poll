...
def notsuperuser(request):
	return render(request, 'poll/notsuperuser.html')
...
def delete(request, poll_id):	
	...
	if request.user.is_superuser:
		if request.method == 'POST':
			post.delete()
			return HttpResponseRedirect("/poll/home")
		return render(request, 'poll/delete.html')
	else:
		return HttpResponseRedirect("/poll/notsuperuser")
